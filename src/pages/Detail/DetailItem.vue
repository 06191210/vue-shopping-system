        ...
        <section class="con">
            ...
            <div class="mainCon">
                ...
                <div class="previewWrap">
                    <!--放大镜效果-->
                    <ZoomItem :skuImageList="skuImageList" />
                    <!-- 小图列表 -->
...
import ZoomItem from "./Zoom/ZoomItem";
// import AllGoods from "@/components/TypeNav/AllGoods.vue";
    ...
    methods:{
        ...
        async addShopCart(){
            try {
                ...
                //一些复杂的信息比如skuInfo，通过会话存储(不持久)传递
                //本地存储|会话存储，一般存储的是字符串
